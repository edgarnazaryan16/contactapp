                ...
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <textarea type="text" name="website" id="website" class="form-control">{{ $company -> website }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <textarea name="address" id="address" rows="3" class="form-control">{{ $company -> address }}</textarea>
                            </div>
                        </div>
                        <hr>
